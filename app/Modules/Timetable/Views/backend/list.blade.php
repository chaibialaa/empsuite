                    ...
                    @foreach($fcList as $m=>$value)
                        <div class="col-md-12">
                            <div class="panel panel-info ">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" href="#collapse-{{$m}}"> <i class="fa fa-tint"></i> Level
                                        : {{$m}}</a>
                                </div>
                                                    ...
                                                    <div class="panel panel-info ">
                                                        <div class="panel-heading">
                                                            <a data-toggle="collapse"
                                                               href="#collapse-{{preg_replace('/\s+/', '', $m)}}-{{preg_replace('/\s+/', '', $u)}}">
                                                                <i class="fa fa-list"></i> Section : {{$u}}</a>
                                                        </div>
                                                        <div id="collapse-{{preg_replace('/\s+/', '', $m)}}-{{preg_replace('/\s+/', '', $u)}}"
                                                                    ...
                                                                    @foreach($i as $g=>$s)
                                                                        <div class="col-md-12">
                                                                            <div class="panel panel-info ">
                                                                                <div class="panel-heading">
                                                                                    <a data-toggle="collapse"
                                                                                       href="#collapse-{{preg_replace('/\s+/', '', $m)}}-{{preg_replace('/\s+/', '', $g)}}"> <i
                                                                                                class="fa fa-list"></i>
                                                                                        Class : {{$g}}</a>
                                                                                </div>
                                                                                <div id="collapse-{{preg_replace('/\s+/', '', $m)}}-{{preg_replace('/\s+/', '', $g)}}"
                                                                                     class="panel-collapse collapse in">
                                                                                    <div class="panel-body">
                                                                                        @foreach($s as $v=>$k)
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="panel panel-info ">
                                                                                                    <div class="panel-heading">
                                                                                                        <a data-toggle="collapse"
                                                                                                           href="#collapse-{{$k[0][0]->level_id}}-{{$k[0][0]->id}}-{{preg_replace('/\s+/', '', $v)}}">
                                                                                                            <i class="fa fa-list"></i>
                                                                                                            Type
                                                                                                            : {{$v}}</a>
                                                                                                    </div>
                                                                                                    <div id="collapse-{{$k[0][0]->level_id}}-{{$k[0][0]->id}}-{{preg_replace('/\s+/', '', $v)}}"
                                                                                                         class="panel-collapse collapse in">
                                                                                                        <div class="panel-body">
                                                                                                            <table id="levelClass"
                                                                                                                    ...
                                                                                                                    @foreach($element as $sub_element=>$val)
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td class="text-center">
                                                                                                                                @if ($val->enb == 1)
                                                                                                                                    <form action="/admin/timetable/disable/{{$val->tid}}"
                                                                                                                                          method="post">
                                                                                                                                        {!! csrf_field() !!}
                                                                                                                                        <button type="submit"
                                                                                                                                ...
                                                                                                                                @else
                                                                                                                                    <form action="/admin/timetable/enable/{{$val->tid}}"
                                                                                                                                          method="post">
                                                                                                                                        {!! csrf_field() !!}
                                                                                                                                        <button type="submit"
                                                                                                                            ...
                                                                                                                            <td class="text-center">
                                                                                                                                <form action="/admin/timetable/edit/{{$val->tid}}"
                                                                                                                                      method="get">
                                                                                                                                    <button type="submit"
